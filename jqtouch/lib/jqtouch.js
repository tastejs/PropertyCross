/*
    ...
    Note: this has been edited slightly to make it compatible with requireJS and
          to fix the hsitory bug with the back button..
*/
define(['lib/zepto'], function(Zepto) {
    ...
    //Return an actual instance for now to save having a separate file
    //to create this.. 
    return new $.jQTouch({
