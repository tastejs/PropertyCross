...
{
  public partial class PropertyCrossViewController : UIViewController, PropertyCrossPresenter.View
  {
    private PropertyCrossPresenter _presenter;

    private LocationsTableSource _locationsTableSource;

    private RecentSearchesTableSource _recentTableSource;

    public PropertyCrossViewController (PropertyCrossPresenter presenter)
      : base ("PropertyCrossViewController", null)
    {
      Title = "PropertyCross";
    ...
    #region PropertyCrossPresenter.View implementation 
