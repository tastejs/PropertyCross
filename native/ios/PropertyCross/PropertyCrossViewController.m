...
@interface PropertyCrossViewController ()

@end

@implementation PropertyCrossViewController
{
...
- (id)init
{
    return [self initWithNibName:@"PropertyCrossViewController"
                          bundle:nil];
}
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Faves"
                                                                              style:UIBarButtonItemStyleBordered
                                                                             target:self
