package com.propertycross.neomad.adapter;
...
import com.propertycross.neomad.adapter.holder.PropertyView;
import com.propertycross.neomad.adapter.holder.ViewHolder;
...
public final class PropertyListAdapter implements ListAdapter, ItemTypeAdapter {
	...
	private View buildRowView(int i) {
		...
		if (type == TYPE_LOAD_MORE) {
			...
			return new PropertyView(screen).getView();
		}
		return null;
	}
